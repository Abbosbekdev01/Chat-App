...
import uz.abbosbek.chatappcodial.adapters.ViewPagerAdapter
import uz.abbosbek.chatappcodial.databinding.FragmentHomeBinding
    ...
    private fun init() {
        ...
        binding.myNavView.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.menu_about -> {
                    Toast.makeText(context, "Chat app: Abbosbek 27.07.2023", Toast.LENGTH_SHORT)
                        .show()
                }
                R.id.menu_add_group -> {
